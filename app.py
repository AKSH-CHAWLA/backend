...
#
# For local development, localhost is used as fallback.

FRONTEND_URL = os.environ.get(
    "FRONTEND_URL",
    "https://marvelous-heliotrope-053358.netlify.app"
).rstrip("/")
...
# Required because Netlify and Render are different domains.
app.config["SESSION_COOKIE_SECURE"] = True
app.config["SESSION_COOKIE_HTTPONLY"] = True
app.config["SESSION_COOKIE_SAMESITE"] = "None"

# 200 MB maximum upload request
...
# ==========================================================
# OPTIONAL FLASK FRONTEND ROUTES
# ==========================================================
...
def convert_to_pdf(input_path: Path):
    ...
    try:
        ...
        return None, (
            f"Could not execute '{soffice_bin}'."
        )
...
def view_pdf(file_id):
    ...
    if row["kind"] == "pdf":
        ...
        if not target.exists():
            ...
            return jsonify({
                "error":
                "The converted PDF is missing on disk. "
                "Try re-uploading."
            }), 410
        ...
        reason = (
            ...
            or
            "No PDF representation available for this file."
        )
